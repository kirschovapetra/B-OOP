...
public class ResetEdge2D extends Edge2D {
    ...
    public ResetEdge2D(Edge edge, Point2D startPoint, Point2D endPoint) throws IllegalArgumentException{
        ...
        arrowHead1 = new ArrowHead(super.getLine2D().getX1(),super.getLine2D().getY1(),
        ...
        arrowHead2 = new ArrowHead(super.getLine2D().getX1(),super.getLine2D().getY1(),
                bottomMiddlePoint.getX(),bottomMiddlePoint.getY(),5,10);
